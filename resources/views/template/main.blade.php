...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="asset/dist/img/1.jpeg" class="user-image" alt="User Image">
              <span class="hidden-xs">Widya Setyaningtyas</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="asset/dist/img/1.jpeg" class="img-circle" alt="User Image">

                <p>
                  Widya Setyaningtyas - Web Developer
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="{{url('barang')}}">
            <i class="fa fa-database"></i> <span>Barang</span>
            <span class="pull-right-container">            
            </span>
          </a>
        </li>
        <li>
          <a href="{{url('jenis')}}">
            <i class="fa fa-list-ul"></i> <span>Jenis</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        <li>
          <a href="{{url('pembeli')}}">
            <i class="fa fa-female"></i> <span>Pembeli</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="https://adminlte.io">widyasetyaningtyas</a>.</strong> All rights
    reserved.
  </footer>
